...
> migración. La firma pasa a verificarse con `Stripe-Signature` y `stripe.webhooks.constructEvent` en lugar del HMAC propio; los once criterios de aceptación se mantienen sin cambio de intención.
>
