...
| A-15 | Socio aprobado debe pagar la primera membresía para quedar `ACTIVE` y poder reservar                                                | RN-ACT-07                     | `POST /payments`, `POST /reservations`                 | IA + E2E | Bloqueante | Pendiente (épica futura EP-04; la pantalla de "pendiente de pago" tras aprobación ya está cubierta en el frontend)                                                                |
