...
| [ADR-0007](./ADR-0007-culqi-sandbox-idempotencia-pagos.md)                | Culqi sandbox e idempotencia de pagos                                    | **Reemplazado por ADR-0011** |
...
| [ADR-0011](./ADR-0011-stripe-sandbox-reemplaza-culqi.md)                  | Stripe (test mode) reemplaza a Culqi como pasarela                       | Aceptado                     |
